...
export const GenerateReportModal: React.FC<GenerateReportModalProps> = ({
  ...
  const types = [
    ...
    { id: 'riscos', label: 'Análise de Riscos', desc: 'Níveis de risco contratual ativos' }
  ];
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
      <div className="absolute inset-0 bg-[#1F1A2C]/50 backdrop-blur-sm transition-opacity" onClick={onClose} />
      
      {/* Expanded Modal Layout for Dual Pane Settings + PDF Live Preview */}
      <div className="relative w-full max-w-6xl bg-slate-100 h-full shadow-2xl flex flex-col z-10 animate-fade-in">
        
        {/* Modal Header */}
        <div className="bg-[#1F1A2C] text-white p-5 flex items-center justify-between border-b border-purple-900/40 shrink-0">
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 bg-purple-700/20 border border-purple-500/30 rounded-xl flex items-center justify-center">
              <FileSpreadsheet className="w-5 h-5 text-purple-400 animate-pulse" />
            </div>
            <div>
              <h2 className="text-lg font-black tracking-tight flex items-center gap-2">
                <span>Central de Relatórios Executivos</span>
                <span className="bg-purple-800 text-purple-300 text-[10px] font-black px-2 py-0.5 rounded-full uppercase">PDF PRO</span>
              </h2>
              <p className="text-xs text-slate-400">Personalize filtros e visualize o PDF em tempo real antes de exportar</p>
            </div>
          </div>
          <button onClick={onClose} className="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 transition-all cursor-pointer">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex-1 flex overflow-hidden flex-col md:flex-row">
          ...
          <div className="w-full md:w-[380px] bg-white border-r border-slate-200 p-6 overflow-y-auto space-y-6 shrink-0">
            <div>
                ...
                {types.map(t => (
                  <button
                    ...
                    className={`w-full p-3.5 text-left rounded-xl border transition-all cursor-pointer flex flex-col ${
                      reportType === t.id 
                        ? "bg-purple-50/60 border-purple-600 text-purple-900 ring-1 ring-purple-100" 
                        : "bg-white border-slate-200 text-slate-600 hover:bg-slate-50 hover:border-slate-300"
                    }`}
                  >
                    <span className="text-xs font-extrabold flex items-center gap-2">
                      <span className={`w-2 h-2 rounded-full ${reportType === t.id ? "bg-purple-600" : "bg-slate-300"}`} />
                      {t.label}
                    </span>
            ...
            <div className="border-t border-slate-100 pt-5">
              ...
              <select 
                ...
                className="w-full p-3 bg-white border border-slate-200 rounded-xl text-xs font-bold text-[#1F1A2C] outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-600 cursor-pointer transition-all"
              >
              ...
              <div className="space-y-2.5">
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-slate-50 hover:bg-slate-100/75 rounded-xl border border-slate-100 transition-all select-none">
                  ...
                  <div className="text-left">
                    <p className="text-xs font-extrabold text-[#1F1A2C]">Detalhar Cadastros</p>
                ...
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-slate-50 hover:bg-slate-100/75 rounded-xl border border-slate-100 transition-all select-none">
                  ...
                  />
                  <div className="text-left">
                    <p className="text-xs font-extrabold text-[#1F1A2C]">Destacar Alertas</p>
                ...
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-slate-50 hover:bg-slate-100/75 rounded-xl border border-slate-100 transition-all select-none">
                  ...
                  />
                  <div className="text-left">
                    <p className="text-xs font-extrabold text-[#1F1A2C]">Planos de Ação</p>
            ...
            <div className="border-t border-slate-100 pt-5 space-y-3">
              <button 
                ...
                className="w-full p-4 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 text-white rounded-xl font-extrabold flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.98] cursor-pointer"
              >
                {isDownloading ? (
                  <>
          ...
          <div className="flex-1 bg-slate-100 p-6 overflow-y-auto flex justify-center">
            <div className="w-full max-w-[794px] min-h-[1123px]">
              ...
              <div 
                ...
                className="bg-white border border-slate-200/80 rounded-2xl shadow-[0_12px_40px_rgba(25,35,56,0.06)] p-10 font-sans text-slate-800 space-y-6 select-none"
                style={{ width: "100%", minHeight: "1050px" }}
              >
                {/* PDF Header Block */}
                <div className="flex items-start justify-between border-b-2 border-purple-900 pb-5 mb-2">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded bg-purple-900 flex items-center justify-center">
                        <span className="text-white font-black text-[9px]">C</span>
                      </div>
                      <span className="text-lg font-black tracking-tight text-[#1F1A2C]">CTM RH BRASIL</span>
                    </div>
                  ...
                  <div className="text-right space-y-1">
                    <span className="inline-block px-3.5 py-1 bg-purple-50 border border-purple-100 text-purple-700 font-black text-[10px] uppercase tracking-wider rounded-lg">
                ...
                <div className="grid grid-cols-4 gap-4 p-4 bg-slate-50/70 border border-slate-150 rounded-2xl text-xs">
                  <div>
                    <span className="text-[9px] uppercase font-black text-slate-400 block tracking-wider">Período de Foco</span>
                    <span className="text-[#1F1A2C] font-extrabold">{periodDays} Dias Futuros</span>
                  </div>
                  <div>
                    <span className="text-[9px] uppercase font-black text-slate-400 block tracking-wider">Metodologia</span>
                    <span className="text-[#1F1A2C] font-extrabold">Análise Preditiva</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="text-purple-700 font-extrabold">{dataQualityPercent}%</span>
                  </div>
                </div>

                {/* Section 1: Executive KPI Panel */}
                <div className="space-y-3">
                  <h3 className="text-xs font-black text-[#1F1A2C] uppercase tracking-widest flex items-center gap-1.5 border-b border-slate-100 pb-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-3.5">
                    <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-150">
                      ...
                      <div className="flex items-baseline gap-2 mt-1">
                        <span className="text-xl font-black text-[#1F1A2C]">{ativos.length}</span>
                    ...
                    <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-150">
                      ...
                      <div className="flex items-baseline gap-2 mt-1">
                        <span className="text-xl font-black text-[#1F1A2C]">{aComecar.length}</span>
                ...
                <div className="space-y-4">
                  ...
                  {(reportType === "geral" || reportType === "executivo") && (
                    <div className="space-y-4">
                      <h4 className="text-xs font-bold text-[#1F1A2C] uppercase tracking-widest">Painel do Resumo de Atividades</h4>
                      <div className="space-y-2.5 text-xs text-slate-600 leading-relaxed">
                        <p>&bull; <strong>Status Operacional</strong>: A equipe de docentes conta com <strong>{ativos.length}</strong> profissionais lecionando atualmente, cobrindo múltiplos turnos e zonas administrativas.</p>
                  ...
                  {reportType === "ferias" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-1.5">
                        <h4 className="text-xs font-bold text-[#1F1A2C] uppercase tracking-widest">Análise de Férias e Elegibilidade</h4>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 bg-slate-50 rounded-xl border border-slate-150">
                          ...
                          <span className="text-lg font-black text-[#1F1A2C] mt-1 block">{feriasAptas.length} colaboradores</span>
                        </div>
                                ...
                                {ativos.slice(0, 6).map((emp, i) => {
                                  ...
                                  return (
                                    <tr key={i} className="hover:bg-slate-50/50">
                                      <td className="p-2 pl-3 font-extrabold text-[#1F1A2C]">{emp.nome}</td>
                  ...
                  {reportType === "contratos" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-1.5">
                        <h4 className="text-xs font-bold text-[#1F1A2C] uppercase tracking-widest">Renovação e Término de Contrato</h4>
                  ...
                  {reportType === "pendencias" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-1.5">
                        <h4 className="text-xs font-bold text-[#1F1A2C] uppercase tracking-widest">Saneamento Cadastral Global</h4>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="p-3 bg-slate-50 rounded-xl border border-slate-150 text-center">
                          ...
                          <span className="text-base font-black text-[#1F1A2C] mt-0.5 block">{totalEmployees}</span>
                        </div>
                        <div className="p-3 bg-slate-50 rounded-xl border border-slate-150 text-center">
                        ...
                        <div className="p-3 bg-slate-50 rounded-xl border border-slate-150 text-center">
                          ...
                          <span className="text-base font-black text-purple-600 mt-0.5 block">{totalActualIssues}</span>
                        </div>
                      </div>
                  ...
                  {reportType === "riscos" && (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-1.5">
                        <h4 className="text-xs font-bold text-[#1F1A2C] uppercase tracking-widest">Matriz de Risco de Contratos</h4>
                        <span className="text-[10px] font-black text-rose-600 bg-rose-50 px-2 py-0.5 rounded-md">
                      ...
                      {includeDetails && (
                        <div className="space-y-2">
                          <p className="text-[10px] uppercase font-black text-slate-400 tracking-wider">Docentes Monitorados por Risco</p>
                          <div className="overflow-hidden border border-slate-150 rounded-xl text-[11px]">
                            <table className="w-full text-left text-xs">
                              <thead>
                                <tr className="bg-slate-50 text-slate-500 font-extrabold border-b border-slate-150">
                                  ...
                                  <th className="p-2 pr-3 text-right">Risco Contratual</th>
                                </tr>
                              </thead>
                              <tbody className="divide-y divide-slate-100">
                                {ativos.slice(0, 6).map((emp, i) => {
                    ...
                    <div className="grid grid-cols-1 gap-2 text-xs">
                      {contratosExpirando.slice(0, 2).map((emp, i) => (
                        <div key={i} className="p-3 bg-rose-50/60 rounded-xl border border-rose-100 flex items-start gap-2.5">
                          ...
                          <div>
                            <p className="font-bold text-[#1F1A2C]">Expiração contratual iminente: {emp.nome}</p>
                      ...
                      {feriasCriticas.slice(0, 1).map((emp, i) => (
                        <div key={i} className="p-3 bg-amber-50/60 rounded-xl border border-amber-150 flex items-start gap-2.5">
                          ...
                          <div>
                            <p className="font-bold text-[#1F1A2C]">Período aquisitivo de férias crítico: {emp.nome}</p>
                            <p className="text-[10px] text-slate-500 mt-0.5">
                      ...
                      {employeesWithIssues.slice(0, 1).map((emp, i) => (
                        <div key={i} className="p-3 bg-purple-50/50 rounded-xl border border-purple-100 flex items-start gap-2.5">
                          <BadgeInfo className="w-4 h-4 text-purple-600 shrink-0 mt-0.5" />
                          <div>
                            <p className="font-bold text-[#1F1A2C]">Perfil cadastral incompleto: {emp.nome}</p>
                            <p className="text-[10px] text-slate-500 mt-0.5">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs leading-normal">
                      <div className="p-3 bg-slate-50 rounded-xl border border-slate-150 flex gap-2">
                        ...
                        <div>
                          <p className="font-extrabold text-[#1F1A2C]">Fidelizar Contratos em Alerta</p>
                      ...
                      <div className="p-3 bg-slate-50 rounded-xl border border-slate-150 flex gap-2">
                        ...
                        <div>
                          <p className="font-extrabold text-[#1F1A2C]">Escalar Banco de Férias</p>
                      ...
                      <div className="p-3 bg-slate-50 rounded-xl border border-slate-150 flex gap-2">
                        ...
                        <div>
                          <p className="font-extrabold text-[#1F1A2C]">Campanha de Saneamento</p>
                          <p className="text-[10px] text-slate-500 mt-1">Cobrar preenchimento das pendências cadastrais dos {employeesWithIssues.length} docentes sinalizados.</p>
                        </div>
                      </div>
                      ...
                      <div className="p-3 bg-slate-50 rounded-xl border border-slate-150 flex gap-2">
                        ...
                        <div>
                          <p className="font-extrabold text-[#1F1A2C]">Previsão de Cobertura</p>
                ...
                <div className="grid grid-cols-2 gap-6 pt-10 border-t border-slate-150 text-[10px] text-slate-400">
                  <div className="border-t border-slate-200 pt-3 text-center">
                    <p className="font-black uppercase tracking-wider text-[#1F1A2C]">COORDENAÇÃO DE RECURSOS HUMANOS</p>
                    <p className="font-semibold text-slate-400 mt-0.5">Responsável pela Geração de Informação</p>
                  </div>
                  <div className="border-t border-slate-200 pt-3 text-center">
                    <p className="font-black uppercase tracking-wider text-[#1F1A2C]">DIREÇÃO GERAL DO CTM BRASIL</p>
